...
import ProileUserBlock from "../../components/ProfileUserBlock/ProileUserBlock";
        ...
        <main className="Main">
          ...
          <div className="UserPosts">
            ...
            <div className="media-container">
              <img
                ...
                src="https://images.pexels.com/photos/17854713/pexels-photo-17854713.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="Post Item"
              />
              <img
                className="media__item"
              ...
              <img
                className="media__item"
                src="https://images.pexels.com/photos/3593922/pexels-photo-3593922.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="Post Item"
              />
              <img
                className="media__item"
              ...
              <img
                className="media__item"
                src="https://images.pexels.com/photos/9927972/pexels-photo-9927972.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="Post Item"
              />
            </div>
          ...
          <div className="Post _liked _marked">
            <div className="UserElem">
              <img src="https://3.bp.blogspot.com/-_3S0EUgYLzs/WSKUDX3meZI/AAAAAAAAAw8/uya8COKgXLsBGdNB-O4WV9aEJj2ZRya2gCLcB/s1600/BMW%2BLogo%2B-%2B1.png" alt="User" />
            ...
            <p className="Post__text">Мощь и элегантность в вашем распоряжении</p>
            <div className="media-container">
              <img
                className="media__item"
                src="https://images.pexels.com/photos/12175733/pexels-photo-12175733.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="Post Item"
              />
              <img
                className="media__item"
              ...
              <img
                className="media__item"
                src="https://images.pexels.com/photos/9846134/pexels-photo-9846134.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="Post Item"
              />
              <img
                className="media__item"
                src="https://images.pexels.com/photos/2062789/pexels-photo-2062789.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Post Item"
              />
              <img
                className="media__item"
                src="https://images.pexels.com/photos/17324141/pexels-photo-17324141/free-photo-of-bmw-g80-m3-canon-6d-mark-ll-35mm-f1-4-1-320-f-1-4-iso-100.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt="Post Item"
              />
              <img
                className="media__item"
                src="https://images.pexels.com/photos/11654779/pexels-photo-11654779.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Post Item"
              />
            </div>
